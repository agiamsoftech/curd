...
<body>
    ...
    <form action="submittudo" method="post">
        @csrf
        <input type="hidden" value="{{$data->id}}" name="totoid">
        <div class="form-group">
            <label for="exampleInputEmail1">Name</label>
            <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter name" value="{{$data->name}}">
